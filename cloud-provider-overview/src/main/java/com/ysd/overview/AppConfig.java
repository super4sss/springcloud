...
import com.ysd.overview.admin.common.AdminRoutes;
import com.ysd.overview.api.common.ApiRoutes;
import com.ysd.overview.common.handler.UrlSeoHandler;
import com.ysd.overview.common.model._MappingKit;
import com.ysd.overview.front.common.FrontRoutes;
...
//		JFinal.start("ysdOverview/src/main/webapp", 9081, "/ysdOverview");
	...
	public void configPlugin(Plugins me) {
    	...
    	plugin.async();
    	plugin.scanPackage("com.ysd.overview");
    	me.add(plugin);
	}
