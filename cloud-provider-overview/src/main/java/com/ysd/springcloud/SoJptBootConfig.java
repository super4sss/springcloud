...
//    DruidPlugin dp = new DruidPlugin(arpProperties.getJdbcUrl(), arpProperties.getUsername(), arpProperties.getPassword());
    DruidPlugin dp=null;
    if (PropKit.getBoolean("app.devMode")){
      dp = new DruidPlugin("jdbc:mysql://localhost:9253/ysd_overview?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&serverTimezone=UTC", "root", "prod1&2019$");
    ...
    dp.setRemoveAbandonedTimeoutMillis(180);
