...
import com.ysd.springcloud.AppConfig;
...
//			"pro_prop", "log_problem", "log_document", "pro_menu"
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.ysd.springcloud.common.model.base";
		// base model 文件保存路径
		...
		String modelPackageName = "com.ysd.springcloud.common.model";
